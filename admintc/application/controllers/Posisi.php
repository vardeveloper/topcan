...
class Posisi extends AUTH_Controller {
	...
	public function index() {
		...
		$data['page'] 		= "profesion";
		$data['judul'] 		= "Datos profesión";
		$data['deskripsi'] 	= "Administrar Datos profesión";
	...
	public function delete() {
		...
		if ($result > 0) {
			echo show_succ_msg('Data Posisi Berhasil dihapus', '18px');
		} else {
			echo show_err_msg('Data Posisi Gagal dihapus', '18px');
		}
	}
