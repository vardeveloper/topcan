...
class Home extends AUTH_Controller
{
    ...
    {
        $data['products_total'] = $this->M_productos->total_rows();
        $data['categories_total'] = $this->M_categorias->total_rows();
        $data['categoryType_total'] = $this->M_tipocategoria->total_rows();
        ...
        $data['page'] = "inicio";
        $data['judul'] = "Inicio";
        $data['deskripsi'] = "Administrar Datos";
