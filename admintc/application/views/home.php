<div class="row">
  <!-- <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-aqua">
      ...
      <a href="<?php echo base_url('Pegawai') ?>" class="small-box-footer">Más Info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-green">
      ...
      <a href="<?php echo base_url('Posisi') ?>" class="small-box-footer">Más Info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-yellow">
      ...
      <a href="<?php echo base_url('Kota') ?>" class="small-box-footer">Más Info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
