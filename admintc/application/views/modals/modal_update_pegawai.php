<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Actualizar Datos Empleado</h3>
      <form method="POST" id="form-update-pegawai">
        ...
        <div class="form-group">
          <div class="col-md-12">
              <button type="submit" class="form-control btn btn-primary"> <i class="glyphicon glyphicon-ok"></i> Actualizar Data</button>
          </div>
        </div>
      </form>
</div>
