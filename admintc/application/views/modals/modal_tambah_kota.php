<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <div class="input-group form-group">
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Ingresar Nombre Categoría" name="kota" aria-describedby="sizing-addon2">
    </div>
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Ingresar Descripción Categoría" name="kota" aria-describedby="sizing-addon2">
    </div>
